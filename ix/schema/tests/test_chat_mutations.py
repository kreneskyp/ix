...
class TestChatInputMutation:
    ...
    def test_chat_input_with_lead_agent(self, mock_openai, chat, mocker):
        # mock start_agent_loop to avoid asyncio
        mocker.patch("ix.schema.mutations.chat.start_agent_loop")
    ...
    def test_chat_input_with_other_agent(self, mock_openai, chat, mocker):
        # mock start_agent_loop to avoid asyncio
        mocker.patch("ix.schema.mutations.chat.start_agent_loop")
